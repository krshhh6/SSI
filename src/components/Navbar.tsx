    ...
    >
      ...
      <div ref={navRef} className="navbar-container px-4 sm:px-6 lg:px-8">
        ...
        <div className="hidden lg:flex items-center" style={{ gap: 10, justifyContent: 'flex-end' }}>
          ...
          {/* Book Service CTA — filled Bosch Red with light highlight */}
          <Link
            href="/booking"
            style={{
              display: 'inline-flex',
              ...
              letterSpacing: '-0.01em',
              transition: 'all 0.18s ease',
              boxShadow: '0 3px 12px rgba(226, 0, 26, 0.32), inset 0 1px 0 rgba(255, 255, 255, 0.28)',
            }}
            onMouseEnter={(e) => {
              const el = e.currentTarget as HTMLElement;
              el.style.boxShadow = '0 6px 18px rgba(226, 0, 26, 0.42), inset 0 1px 0 rgba(255, 255, 255, 0.35)';
              el.style.transform = 'translateY(-1px)';
            }}
            onMouseLeave={(e) => {
              const el = e.currentTarget as HTMLElement;
              el.style.boxShadow = '0 3px 12px rgba(226, 0, 26, 0.32), inset 0 1px 0 rgba(255, 255, 255, 0.28)';
              el.style.transform = 'translateY(0)';
            }}
          >
        ...
        <div className="navbar-mobile-actions flex lg:hidden items-center" style={{ gap: 8, justifyContent: 'flex-end' }}>
          ...
          {/* Book Service Quick Button — tablet only, hidden on narrow mobile to avoid crowding */}
          <Link
            href="/booking"
            ...
            >
              ...
              >
                <div>
                    ...
                    >
                      ...
                      <div style={{ display: 'flex', flexDirection: 'column', textAlign: 'left' }}>
                        ...
                        <div style={{ display: 'flex', alignItems: 'center', gap: 6, marginTop: 2 }}>
                          ...
                          <span style={{ fontSize: '0.64rem', fontWeight: 600, color: '#64748B' }}>
                            Patna
                          </span>
                        </div>
                      </div>
                  ...
                  >
                    <div>
                      <div style={{ fontSize: '0.64rem', fontWeight: 800, letterSpacing: '0.08em', color: '#64748B', textTransform: 'uppercase' }}>
                        Workshop Helpline
                      </div>
                      <div style={{ fontSize: '0.88rem', fontWeight: 800, color: '#0F172A', fontFamily: 'Outfit, sans-serif', marginTop: 2 }}>
                        +91 90283 84499
                      </div>
                    </div>
                    <a
