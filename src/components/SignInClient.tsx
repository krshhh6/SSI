  ...
  return (
    <section style={{ minHeight: "100vh", display: "flex", alignItems: "center", justifyContent: "center", background: "var(--bg)", position: "relative", overflow: "hidden", paddingTop: 80, paddingBottom: 40 }}>
      ...
      >
        ...
        >
          {/* Top gradient bar */}
          <div style={{ position: "absolute", top: 0, left: 0, right: 0, height: 2, background: "linear-gradient(90deg, #0066FF, #0066FF)" }} />
          ...
          <motion.div
            ...
            style={{
              ...
              background: "linear-gradient(135deg, #0066FF, #A0000F)",
