...
const QUICK_LINKS = ["Home", "Services", "Bosch Advantage", "Reviews", "Gallery", "Contact"];
const SERVICES_LIST = [
              ...
              {QUICK_LINKS.map((link) => (
                <li key={link}>
                  <motion.a
                    ...
                    onClick={(e) => {
                      e.preventDefault();
                      document.querySelector(`#${link.toLowerCase().replace(/\s+/g, "-")}`)?.scrollIntoView({ behavior: "smooth" });
                    }}
